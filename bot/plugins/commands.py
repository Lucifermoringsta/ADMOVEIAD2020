...
async def start(bot, update):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton
                                (
                                    '🤯 DOTS JOIN 🤯', url=f"{MT_BOT_UPDATES}"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '😈 JOIN MY GOOUP😈', url="https://t.me/ADMOVEIAD"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🎥 JOIN MY CANNEIL 🎥', url='https://t.me/ADMOVEI')
    ]]
